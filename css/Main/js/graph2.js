...
$(function() {
  ...
  function drawChart() {
    ...
    var data = google.visualization.arrayToDataTable([
      ...
      ['Global',    null,                 0,                               0],
      ['Music 21.8%',   'Global',             0,                               0],
      ['LifeStyle 26.3%',    'Global',             0,                               0],
      ['Sports 17.4%',      'Global',             0,                               0],
      ['Media 34.4%', 'Global',             0,                               0],
      ['CD\'s 13.4%' ,    'Music 21.8%',            11,                              10],
      ['iTunes 62.4%',       'Music 21.8%',            52,                              31],
      ['Concerts 24.2%',    'Music 21.8%',            24,                              12],
      ['Pottery Classes 38.2%',    'LifeStyle 26.3%',             42,                              -11],
      ['Dance Classes 28.3%',   'LifeStyle 26.3%',             31,                              -2],
      ['Golf 22.3%',    'LifeStyle 26.3%',             22,                              -13],
      ['Gardening 11.2% ',        'LifeStyle 26.3%',             21,                              -5],
      ['Cardinal Tickets 56.2%',     'Sports 17.4%',               36,                              4],
      ['Sports Equipment 43.7%',     'Sports 17.4%',               20,                              -12],
      ['Books 32.2%%',      'Media 34.4%',               80,                               34],
      ['Print 11.2%',  'Media 34.4%',               7,                               -5],
      ['Netflix 7.2%',    'Media 34.4%',               10,                              24],
      ['Hulu 28.4%',      'Media 34.4%',               18,                              13],
      ['Cinemas 21%',  'Media 34.4%',               15,                              -52]
    ]);
  ...
  function drawChart3() {
    ...
    var data = google.visualization.arrayToDataTable([
      ['Location', 'Parent', 'Market trade volume (size)', 'Market increase/decrease (color)'],
      ['Global',    null,                 0,                               0],
      ['Gym Membership 19.3%',   'Global',             0,                               0],
      ['Beauty 32.1%',    'Global',             0,                               0],
      ['Health Supplements 48.5%',      'Global',             0,                               0],
      ['Gold\'s Gym',    'Gym Membership 19.3%',            11,                              10],
      ['Four Seasons',       'Gym Membership 19.3%',            52,                              31],
      ['Cosmetics 35.1%',    'Beauty 32.1%',             42,                              -11],
      ['Hair Cuts 22.4%',   'Beauty 32.1%',             31,                              -2],
      ['Clothing 41.5%', 'Beauty 32.1%', 50, 3],
      ['Sports Nutrition',     'Health Supplements 48.5%',               36,                              4],
      ['Vitamins',     'Health Supplements 48.5%',               20,                              -12],
      ['Digestion',     'Health Supplements 48.5%',               40,                              63],
      ['Heart Health',      'Health Supplements 48.5%',               4,                               34],
      ['Bones & Joints',  'Health Supplements 48.5%',               1,                               -5],
      ['Herbs',    'Health Supplements 48.5%',               12,                              24],
      ['Diet Products',      'Health Supplements 48.5%',               18,                              13],
      ['Enzymes',  'Health Supplements 48.5%',               11,                              -52]
    ]);
